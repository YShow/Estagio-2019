...
public class ControladorMenuVenda {
	...
	try {
	    ...
	    tcCodCaixa.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Vendas,Integer>, ObservableValue<Integer>>() {
	    ...
	    tcCodCliente.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Vendas,Integer>, ObservableValue<Integer>>() {
